...
import com.carver.paul.truesight.ImageRecognition.LoadHeroXml;
import com.carver.paul.truesight.ImageRecognition.RecognitionModel;
import com.carver.paul.truesight.ImageRecognition.SimilarityTest;
import com.carver.paul.truesight.Models.AdvantagesDownloader.Downloader;
import com.carver.paul.truesight.R;
import com.carver.paul.truesight.Ui.HeroesDetected.HeroesDetectedPresenter;
import com.carver.paul.truesight.Ui.MainActivityPresenter;
...
public class DataManager {
    ...
    public void sendUpdatedHeroList(List<HeroInfo> heroInfoList, boolean completelyNewList) {
        ...
        for(IInfoPresenter_Data p : mInfoPresenters) p.setEnemyHeroes(heroInfoList);
    ...
    private void setupAdvantagesSubscriber(final List<String> heroNames,
        ...
        mAdvantagesSubscriber = new Subscriber<List<HeroAndAdvantages>>() {
            ...
            public void onNext(List<HeroAndAdvantages> heroAndAdvantages) {
                ...
                for(IInfoPresenter_Data p : mInfoPresenters)
                    p.setAdvantageData(heroAndAdvantages);
            }
        };
    }
